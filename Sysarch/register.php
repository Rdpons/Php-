...
if(isset($_POST['save']))
{
	...
	$sql_query = "INSERT INTO users (idno,firstName,middleName,lastName,password,age,gender,contact,email,address)
	VALUES ('$idno','$firstName','$middleName','$lastName','$password','$age','$gender','$contact','$email','$address')";
...
<div class="container">
    ...
    <form action="register.php" method="post" class="registration-container">
